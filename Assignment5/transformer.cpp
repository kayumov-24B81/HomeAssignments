...
bool Transformer :: self_destruction()
{
    std :: cout << "self_destruction() called by Transformer object" << std :: endl;
    return true;
}

bool Transformer :: call_reinforcements()
{
    std :: cout << "call_reinforcements() called by Transformer object" << std :: endl;
    return true;
}
