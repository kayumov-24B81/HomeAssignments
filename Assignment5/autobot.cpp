...
bool Autobot :: self_destruction()
{
    std :: cout << "self_destruction() called by Autobot object" << std :: endl;
    return true;
}

bool Autobot :: call_reinforcements()
{
    std :: cout << "call_reinforcements() called by Autobot object" << std :: endl;
    return true;
}
